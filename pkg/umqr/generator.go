...
func GenerateMerchantQR(merchantName, city, alias, provider string, amount decimal.Decimal, reference string) string {
	enc := NewEncoder()
	...
	if amount.IsPositive() {
		enc.Set(TagTransactionAmount, amount.String())
	}
